// Changed the import for 'chalk' to a dynamic import because 'chalk@5' is an ECMAScript Module (ESM) 
// and cannot be used directly with 'require' in a CommonJS environment. 
// This ensures compatibility without changing the project's module system or configuration.
